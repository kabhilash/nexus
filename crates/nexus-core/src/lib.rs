...
pub use event::{
    ...
    BtFailureReason, BtTransport, ConnectivityState, DisconnectReason, FixMode, GnssFix,
    NexusEvent, PairingAnswer, PairingJobId, PairingPromptData, PairingPromptKind, ProfileKind,
    SatInfo, SecurityMode, WifiState,
};
