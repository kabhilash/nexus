...
pub use event::{
    ...
    BtFailureReason, BtTransport, DisconnectReason, FixMode, GnssFix, NexusEvent, PairingJobId,
    PairingPromptData, PairingPromptKind, ProfileKind, SatInfo, SecurityMode, WifiState,
};
